...
const FormMultiSelect: React.FC<MultiSelectProps> = ({
    ...
    const handleSelect = (optionValue: string) => {
        ...
        if (handleChange) handleChange(newSelectedOptions);
    };
            ...
            <div className="relative z-20 inline-block w-full">
                <div className="relative flex flex-col items-center">
                    <div onClick={toggleDropdown} className="w-full">
                        <div className="mb-2 flex h-min-[300px] rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-none transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300">
